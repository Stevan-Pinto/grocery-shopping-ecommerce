...
<section class="banner-container">
    ...
    <div class="banner">
        ...
        <div class="content">
            <h3>special offer</h3>
            <p>upto 45% off</p>
            <a href="#" class="btn-box">check out</a>
        </div>
    </div>
...
<section class="category" id="category">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>Dry Fruits</h3>
            <p>upto 44% off</p>
            <img src="images/dry-fruits1.jpg" alt="">
            <a href="category.php?category=dryfruits" class="btn">shop now</a>
        </div>
        <div class="box">
            <h3>Beverages</h3>
            <p>upto 35% off</p>
            <img src="images/beverage1.png" alt="">
            <a href="category.php?category=beverages" class="btn">shop now</a>
        </div>
        <div class="box">
            <h3>Fruits</h3>
            <p>upto 12% off</p>
...
<section class="products">
   ...
   <form action="" class="box" method="POST">
      ...
      <div class="flex">
            <div name="p_price" class="price"><span>₹</span><?= $fetch_products['price']; ?></div>
            <input type="number" name="p_qty" class="qty" min="1" max="99" value="1" maxlength="2">
         </div>
